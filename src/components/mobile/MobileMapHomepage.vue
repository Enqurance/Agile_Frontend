    ...
    <div>
        ...
        <div class="on_div" style="width: 100%;">
            ...
            <div class="type_class">
                <el-checkbox-group v-model="checkedTypes" style="padding-left: 10%; width: 100px"
                                   @change="markers_change">
    ...
    methods: {
        ...
        update_pin(e) {
            ...
            if (info.name !== e.name || info.type !== e.type) {
                ...
                this.markerClusterers[e.id] = Object.assign({}, {
                    'id': e.id,
                    'weight': parseInt(e.id)
                }, this.markers_info[e.id])
                this.create_cluster()
            }
        },
